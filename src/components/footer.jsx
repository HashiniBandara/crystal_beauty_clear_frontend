      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/products" className="hover:underline hover:text-pink-200 transition">Shop</Link>
              </li>
              <li>
                <Link to="/about" className="hover:underline hover:text-pink-200 transition">About Us</Link>
              </li>
              <li>
                <Link to="/contact" className="hover:underline hover:text-pink-200 transition">Contact</Link>
              </li>
              <li>
                <Link to="/faq" className="hover:underline hover:text-pink-200 transition">FAQs</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4 text-xl mt-1">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-pink-200 transition"><FaFacebookF /></a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-pink-200 transition"><FaInstagram /></a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-pink-200 transition"><FaTwitter /></a>
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="hover:text-pink-200 transition"><SiTiktok /></a>
            </div>
          </div>
        </div>
      </div>
